    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('target_user_id') ?></th>
                <th scope="col"><?= $this->Paginator->sort('reviewer_user_id') ?></th>
                <th scope="col"><?= $this->Paginator->sort('deliveryinfo_id') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $this->Number->format($rating->target_user_id) ?></td>
                <td><?= $this->Number->format($rating->reviewer_user_id) ?></td>
                <td><?= $this->Number->format($rating->deliveryinfo_id) ?></td>
