...
class RatingsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['TargetUsers', 'ReviewerUsers', 'Deliveryinfos'],
        ];
    ...
    public function add()
    {
        ...
        $targetUsers = $this->Ratings->TargetUsers->find('list', ['limit' => 200]);
        $reviewerUsers = $this->Ratings->ReviewerUsers->find('list', ['limit' => 200]);
        $deliveryinfos = $this->Ratings->Deliveryinfos->find('list', ['limit' => 200]);
        $this->set(compact('rating', 'targetUsers', 'reviewerUsers', 'deliveryinfos'));
    }
